...
Gem::Specification.new do |s|
  ...
  s.date = "2014-06-18"
  s.files = %w(.gitignore LICENSE README.markdown Rakefile app/controllers/admin/taxons_controller_decorator.rb
              app/controllers/admin/yandex_market_settings_controller.rb app/helpers/admin/yandex_markets_helper.rb
              app/models/yandex_market_configuration.rb app/overrides/yandex_market_admin_tabs.rb
              ...
              config/locales/en-US.yml config/locales/ru.yml config/routes.rb
              db/migrate/20110110094042_add_export_flag_to_product.rb db/migrate/20120424050308_add_export_flag_to_taxon.rb
              ...
              lib/export/olx_exporter.rb lib/export/price_ru_exporter.rb lib/export/retail_rocket_exporter.rb
              lib/export/segmento_exporter.rb lib/export/torg_mail_ru_exporter.rb lib/export/tradego_exporter.rb
              lib/export/trusted_service_exporter.rb lib/export/wikimart_exporter.rb lib/export/yandex_market_exporter.rb
              lib/generators/spree_yandex_market/install_generator.rb lib/spree/yandex_market/config.rb
              lib/spree_yandex_market.rb lib/spree_yandex_market_hooks.rb lib/tasks/yandex_market.rake
              spec/controllers/admin/yandex_markets_controller_spec.rb spec/controllers/yandex_market_controller_spec.rb
              spec/helpers/admin/yandex_markets_helper_spec.rb spec/helpers/yandex_market_helper_spec.rb spec/spec.opts
              spec/spec_helper.rb spree_yandex_market.gemspec)
