...
Gem::Specification.new do |s|
  ...
  s.date = "2014-06-18"
  s.files = [".gitignore", "LICENSE", "README.markdown", "Rakefile", "app/controllers/admin/taxons_controller_decorator.rb",
             "app/controllers/admin/yandex_market_settings_controller.rb", "app/helpers/admin/yandex_markets_helper.rb",
             "app/models/yandex_market_configuration.rb", "app/overrides/yandex_market_admin_tabs.rb", "app/views/admin/yandex_market_settings/currency.html.erb",
             "app/views/admin/yandex_market_settings/export_files.html.erb", "app/views/admin/yandex_market_settings/general.html.erb",
             ...
             "lib/generators/spree_yandex_market/install_generator.rb", "lib/spree/yandex_market/config.rb", "lib/spree_yandex_market.rb",
             "lib/spree_yandex_market_hooks.rb", "lib/tasks/yandex_market.rake", "spec/controllers/admin/yandex_markets_controller_spec.rb",
             "spec/controllers/yandex_market_controller_spec.rb", "spec/helpers/admin/yandex_markets_helper_spec.rb",
             "spec/helpers/yandex_market_helper_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "spree_yandex_market.gemspec"]
